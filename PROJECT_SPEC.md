...
- **Mobile experience:** Phone layouts use a compact header, a keyboard-accessible Menu that includes Book Now, touch-sized controls, reduced vertical spacing, single-column content stacks, and full-width primary actions. Desktop/tablet compositions remain intact above the phone breakpoint.
